#include "view_3D.h"
#include "ui_view_3D.h"

#include "ui_mainwindow.h"
#include "mainwindow.h"

view3D::view3D(QWidget *parent, NIFTImage *fatImage, NIFTImage *waterImage, SubjectConfig *subConfig, TracingData *tracingData) :
    QWidget(parent),
    ui(new Ui::view3D),
...
MainWindow *view3D::parentMain()
{
    return static_cast<MainWindow *>(this->parent());
}

void view3D::readSettings()
{
    QSettings settings;
...
bool view3D::loadImage(QString path)
{
...
void view3D::setEnableSettings(bool enable)
{
...
void view3D::actionOpen_triggered()
{
...
void view3D::actionSave_triggered()
{
...
void view3D::actionSaveAs_triggered()
{
...
void view3D::actionImportTracingData_triggered()
{
    // Start dialog to select existing directory to save the tracing results
...
void view3D::upShortcut_triggered()
{
    ...
    undoStack->push(new LocationChangeCommand(QVector4D(Location::NoChange, value, Location::NoChange, Location::NoChange), ui->glWidgetAxial, NULL,
...
void view3D::downShortcut_triggered()
{
    const int value = ui->glWidgetAxial->getLocation().y() - 1;
    if (value < 0)
        return;
...
void view3D::leftShortcut_triggered()
{
    ...
    undoStack->push(new LocationChangeCommand(QVector4D(Location::NoChange, Location::NoChange, value, Location::NoChange), ui->glWidgetAxial, NULL,
                                              ui->axialSliceSlider, ui->axialSliceSpinBox, ui->coronalSliceSlider,
                                              ui->coronalSliceSpinBox, ui->saggitalSliceSlider, ui->saggitalSliceSpinBox));
}

void view3D::rightShortcut_triggered()
{
    const int value = ui->glWidgetAxial->getLocation().z() + 1;
...
void view3D::on_axialSliceSlider_valueChanged(int value)
{
...
void view3D::on_axialSliceSpinBox_valueChanged(int value)
{
    // If the new value is equal to the current slice, then do nothing
    if (value == ui->glWidgetAxial->getLocation().z())
        return;
...
void view3D::on_coronalSliceSlider_valueChanged(int value)
{
    // If the new value is equal to the current slice, then do nothing
...
void view3D::on_coronalSliceSpinBox_valueChanged(int value)
{
    // If the new value is equal to the current slice, then do nothing
    if (value == ui->glWidgetAxial->getLocation().y())
        return;
...
void view3D::on_saggitalSliceSlider_valueChanged(int value)
{
    // If the new value is equal to the current slice, then do nothing
    ...
    undoStack->push(new LocationChangeCommand(QVector4D(value, Location::NoChange, Location::NoChange, Location::NoChange), ui->glWidgetAxial, NULL,
                                              ui->axialSliceSlider, ui->axialSliceSpinBox, ui->coronalSliceSlider,
                                              ui->coronalSliceSpinBox, ui->saggitalSliceSlider, ui->saggitalSliceSpinBox));
}

void view3D::on_saggitalSliceSpinBox_valueChanged(int value)
{
    // If the new value is equal to the current slice, then do nothing
    if (value == ui->glWidgetAxial->getLocation().x())
        return;
...
void view3D::on_brightnessSlider_valueChanged(int value)
{
...
void view3D::on_brightnessSpinBox_valueChanged(int value)
{
    // If the new value is equal to the current value, then do nothing
    if (value / 100.0f == ui->glWidgetAxial->getBrightness())
        return;
...
void view3D::on_brightnessThresSpinBox_valueChanged(int value)
{
    // If the new value is equal to the current value, then do nothing
...
void view3D::on_contrastSlider_valueChanged(int value)
{
    // If the new value is equal to the current value, then do nothing
...
void view3D::on_contrastSpinBox_valueChanged(int value)
{
    // If the new value is equal to the current value, then do nothing
    if (value / 100.0f == ui->glWidgetAxial->getContrast())
        return;
...
void view3D::on_primColorMapComboBox_currentIndexChanged(int index)
{
...
void view3D::on_primOpacitySlider_valueChanged(int value)
{
    // If the new value is equal to the current value, then do nothing
...
void view3D::on_primOpacitySpinBox_valueChanged(int value)
{
    // If the new value is equal to the current value, then do nothing
    if (value / 100.0f == ui->glWidgetAxial->getPrimOpacity())
        return;
...
void view3D::on_secdColorMapComboBox_currentIndexChanged(int index)
{
    // If the index is out of the acceptable bounds for the ColorMap, then do nothing
...
void view3D::on_secdOpacitySlider_valueChanged(int value)
{
    // If the new value is equal to the current value, then do nothing
...
void view3D::on_secdOpacitySpinBox_valueChanged(int value)
{
    // If the new value is equal to the current value, then do nothing
    if (value / 100.0f == ui->glWidgetAxial->getSecdOpacity())
        return;
...
void view3D::changeSliceView(SliceDisplayType newType)
{
...
void view3D::on_fatRadioBtn_toggled(bool checked)
{
    if (checked)
        changeSliceView(SliceDisplayType::FatOnly);
}

void view3D::on_waterRadioBtn_toggled(bool checked)
{
    if (checked)
        changeSliceView(SliceDisplayType::WaterOnly);
}

void view3D::on_fatFracRadioBtn_toggled(bool checked)
{
    if (checked)
        changeSliceView(SliceDisplayType::FatFraction);
}

void view3D::on_waterFracRadioBtn_toggled(bool checked)
{
    if (checked)
        changeSliceView(SliceDisplayType::WaterFraction);
}

void view3D::on_fatWaterRadioBtn_toggled(bool checked)
{
    if (checked)
        changeSliceView(SliceDisplayType::FatWater);
}

void view3D::on_waterFatRadioBtn_toggled(bool checked)
{
    if (checked)
        changeSliceView(SliceDisplayType::WaterFat);
}

void view3D::on_resetViewBtn_clicked()
{
    undoStack->push(new ResetViewCommand(ui->glWidgetAxial, NULL));
}

void view3D::changeTracingLayer(TracingLayer newLayer)
{
...
void view3D::on_EATRadioBtn_toggled(bool checked)
{
    if (checked)
        changeTracingLayer(TracingLayer::EAT);
}

void view3D::on_IMATRadioBtn_toggled(bool checked)
{
    if (checked)
        changeTracingLayer(TracingLayer::IMAT);
}

void view3D::on_PAATRadioBtn_toggled(bool checked)
{
    if (checked)
        changeTracingLayer(TracingLayer::PAAT);
}

void view3D::on_PATRadioBtn_toggled(bool checked)
{
    if (checked)
        changeTracingLayer(TracingLayer::PAT);
}

void view3D::on_SCATRadioBtn_toggled(bool checked)
{
    if (checked)
        changeTracingLayer(TracingLayer::SCAT);
}

void view3D::on_VATRadioBtn_toggled(bool checked)
{
    if (checked)
        changeTracingLayer(TracingLayer::VAT);
}

void view3D::on_EATCheckBox_toggled(bool checked)
{
...
void view3D::on_IMATCheckBox_toggled(bool checked)
{
...
void view3D::on_PAATCheckBox_toggled(bool checked)
{
...
void view3D::on_PATCheckBox_toggled(bool checked)
{
...
void view3D::on_SCATCheckBox_toggled(bool checked)
{
...
void view3D::on_VATCheckBox_toggled(bool checked)
{
...
void view3D::changeDrawMode(DrawMode newMode)
{
...
void view3D::on_drawPointsBtn_toggled(bool checked)
{
    if (checked)
        changeDrawMode(DrawMode::Points);
}

void view3D::on_eraserBtn_toggled(bool checked)
{
    if (checked)
        changeDrawMode(DrawMode::Erase);
}

void view3D::on_eraserBrushWidthComboBox_currentIndexChanged(int index)
{
    switch (index)
    {
...
void view3D::undoStack_canUndoChanged(bool canUndo)
{
    parentMain()->ui->actionUndo->setEnabled(canUndo);
}

void view3D::undoStack_canRedoChanged(bool canRedo)
{
